...
df = pd.read_excel(r'C:\Users\tgome\Documents\Tomas Gomez Villa\2022-1 RSB\RGP\Raw_Data_Last_Version.xlsx', sheet_name='BTC_Twitter_All',header=1)
...
train_results = model.fit((x_train_scaled, x_train_2, x_train_3,x_train_4), [y_train,y_train,y_train],epochs=2000,validation_data=((x_validation_scaled,x_validation_2,x_validation_3,x_validation_4),[y_validation,y_validation,y_validation]))
