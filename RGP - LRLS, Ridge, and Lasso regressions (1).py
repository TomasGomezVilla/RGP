...
df = pd.read_excel(r'C:\Users\tgome\Documents\Tomas Gomez Villa\2022-1 RSB\RGP\Raw_Data_Last_Version.xlsx', sheet_name='BTC_Twitter_Vol',header=1)
...
positive=df.columns[1]
negative=df.columns[2]
